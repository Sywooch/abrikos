...
class MetaTags extends Component
{
	public function init()
	{
		...
		\Yii::$app->view->registerMetaTag(['property'=>'fb:app_id', 'content'=>'935323086485431']);
		...
		\Yii::$app->view->registerMetaTag(['property' => 'og:image:secure_url', 'content' => 'https://'.$_SERVER['SERVER_NAME'].'/images/logo.png'],'og-imagesec');
